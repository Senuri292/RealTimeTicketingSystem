...
public class TicketPool {
    ...
    public String getTicketReleaseDate() {
        return ticketReleaseDate;
    }

    public void setTicketReleaseDate(String ticketReleaseDate) {
        this.ticketReleaseDate = ticketReleaseDate;
    }

    public String getCustomerRetrievalDate() {
        return customerRetrievalDate;
    }

    public void setCustomerRetrievalDate(String customerRetrievalDate) {
        this.customerRetrievalDate = customerRetrievalDate;
    }
